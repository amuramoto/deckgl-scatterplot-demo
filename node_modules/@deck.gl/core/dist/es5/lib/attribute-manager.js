...
var _attribute2 = _interopRequireDefault(require("./attribute"));
...
var AttributeManager = function () {
  ...
  (0, _createClass2.default)(AttributeManager, [{
    ...
    value: function update() {
      ...
      for (var attributeName in this.attributes) {
        ...
        if (attribute.userData.shaderAttributes) {
          var shaderAttributes = attribute.userData.shaderAttributes;
    ...
    value: function getChangedAttributes() {
      ...
      for (var _attributeName in changedAttributes) {
        var _attribute = changedAttributes[_attributeName];

        if (_attribute.userData.shaderAttributes) {
          var shaderAttributes = _attribute.userData.shaderAttributes;

          for (var shaderAttributeName in shaderAttributes) {
            changedShaderAttributes[shaderAttributeName] = shaderAttributes[shaderAttributeName];
          }
        } else {
          changedShaderAttributes[_attributeName] = _attribute;
        }
      }
    ...
    key: "_addShaderAttributes",
    value: function _addShaderAttributes(attribute, shaderAttributes, extraProps) {
      attribute.userData.shaderAttributes = {};

      for (var shaderAttributeName in shaderAttributes) {
        var shaderAttribute = shaderAttributes[shaderAttributeName];
        attribute.userData.shaderAttributes[shaderAttributeName] = this._createAttribute(shaderAttributeName, shaderAttribute, extraProps, true);
      }
    }
  }, {
    key: "_createAttribute",
    value: function _createAttribute(name, attribute, extraProps) {
      var forceNoAlloc = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : false;
      var props = {
        id: name,
      ...
      return new _attribute2.default(this.gl, Object.assign({}, attribute, props));
    }
  }, {
